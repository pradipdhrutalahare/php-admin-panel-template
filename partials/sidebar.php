...
<nav class="navbar bg-light siderbar">
         ...
         <li class="nav-item accordion-content hide" >
             ...
             <ul class="description navbar-nav">
               ...
               <li class="nav-item">
                 ...
                 <li class="nav-item">
                     <a class="nav-link content-link" href="dashboard.php?cat=website-setting$subsite-setting">Website-Setting</a>
                 </li>

                 <li class="nav-item">
                     <a class="nav-link content-link" href="dashboard.php?cat=website-settting$subsite-setting">Them Setting</a>
                 </li>
             </ul>
         </li>
...
<li class="nav-item accordion-content hide">
    ...
    <li class="nav-item ">
        <a class="nav-link contect-link" href="dashboard.php?cat=contact&subcat=contact-details">Contact Detail</a>
    </li>

    <li class="nav-item">
        <a class="nav-link contect-link" href="dashboard.php?cat=contact=&subcact-us-message">Contact Message</a>
    </li>
    <li class="nav-item">
        <a class="nav-link contect-link" href="dashboard.php?cat=contact&subcat=contact-email">Contact Email</a>
    </li>
    </ul>
</li>
...
<li class="nav-item accordion-content hide">
    ...
    <ul class="description navbark-nav">
        <li class="nav-item">
...
<!--codingstatus/php-admin-panel-template -->